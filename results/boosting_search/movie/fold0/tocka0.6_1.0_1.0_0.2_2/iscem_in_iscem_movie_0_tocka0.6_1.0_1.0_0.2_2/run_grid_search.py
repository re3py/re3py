...
for train_set, test_set in create_folds(train_set_all, n_folds=2):
    learner = GradientBoosting(2, shrinkage=shrinkage, step_size=step_size, chosen_examples=chosen_examples,
                               **tree_params)
