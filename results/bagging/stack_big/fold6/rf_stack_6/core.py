...
class DecisionTree(PredictiveModel):
    ...
    def __init__(self,
                 ...
                 max_proportion_of_evaluated_tests_per_node=1.0,
        ...
        self.max_proportion_of_evaluated_tests_per_node = max_proportion_of_evaluated_tests_per_node
    ...
    def chosen_tests(self, tests_generator, current_vars_per_type):
        ...
        # print()
        k_proportion = round(self.max_proportion_of_evaluated_tests_per_node * nb_tests)
    ...
    def build(self, data: Dataset):
        ...
        if self.java_port is not None:
            # open server
            self.p = subprocess.Popen(r"java -jar speedUp.jar {}".format(self.java_port), shell=True)
