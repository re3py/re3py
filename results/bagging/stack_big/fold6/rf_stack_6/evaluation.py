...
class ClassificationEvaluator(Evaluator):
    def __init__(self, class_values, positive_class=None):
        """
        ...
        # When we will be interested in area under the curve errors, we will move this to a subclass:
...
class Accuracy(ClassificationEvaluator):
    def __init__(self, class_values, positive_class=None):
        super().__init__(class_values, positive_class)
